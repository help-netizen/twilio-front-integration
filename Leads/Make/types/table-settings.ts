...
export const DEFAULT_COLUMNS: TableColumn[] = [
  ...
  { id: 'jobType', label: 'Job Type', visible: true, order: 4 },
  { id: 'jobSource', label: 'Source', visible: true, order: 5 },
  { id: 'created', label: 'Created', visible: true, order: 6 },
  { id: 'serialId', label: 'ID', visible: true, order: 7 },
];