...
const ROUTE_PERMISSION_EXCEPTIONS = new Map([
    ...
    ['backend/src/routes/notification-policies.js:router:GET:/notifications', 'Authenticated tenant members read only their request-derived company/user category settings.'],
    ['backend/src/routes/notification-policies.js:router:PATCH:/notifications/:category', 'Authenticated tenant members update only their request-derived company/user category tuple.'],
