...
- **Steps:** apply `rollback_172_rate_me.sql`; then re-apply `172_rate_me.sql` (leave the DB migrated for other suites).
...
| T10 migration 172 | TC-T10-DB-01/02/03 | P0, P1, P2 | db ×3 |
