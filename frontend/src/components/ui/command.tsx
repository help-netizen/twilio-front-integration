  ...
  return (
    <Dialog {...props}>
      <DialogContent className="overflow-hidden p-0">
        ...
        <Command className="**:data-[slot=command-input-wrapper]:h-12 [&_[cmdk-group-heading]]:text-muted-foreground [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:font-medium [&_[cmdk-group]]:px-2 [&_[cmdk-input]]:h-12 [&_[cmdk-item]]:px-2 [&_[cmdk-item]]:py-3 [&_[cmdk-list]]:max-h-[300px]">
          {children}
        </Command>
      </DialogContent>
    </Dialog>
