...
export function WizardStep1(s: WizardState) {
    return (
        <div className="wizard__body">
            <div className="wizard__section-title"><MapPin className="w-4" /> Service Territory Check</div>
            ...
            <div className="wizard__section-title"><User className="w-4" /> Customer Info</div>
