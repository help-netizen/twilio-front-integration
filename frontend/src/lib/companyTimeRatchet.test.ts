...
const NUMBER_LOCALE_LEDGER = [
    ...
    "components/documents/TemplateLivePreview.tsx:return '$' + Number(value || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 });",
    "components/estimates/EstimateDetailPanel.tsx:return '$' + Number(value || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 });",
    "components/estimates/EstimateEditorDialog.tsx:return '$' + Number(value || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 });",
    "components/estimates/ItemPresetSearchCombobox.tsx:return '$' + Number(value || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 });",
    "components/invoices/InvoiceCollectPaymentDialog.tsx:return '$' + value.toLocaleString('en-US', {",
    "components/invoices/InvoiceDetailPanel.tsx:return '$' + Number(value || 0).toLocaleString('en-US', {",
    "components/invoices/InvoiceEditorDialog.tsx:return '$' + Number(value || 0).toLocaleString('en-US', {",
    "components/invoices/InvoiceMobileRow.tsx:return '$' + Number(value || 0).toLocaleString('en-US', {",
    "components/invoices/InvoiceSendDialog.tsx:return '$' + Number(value || 0).toLocaleString('en-US', {",
