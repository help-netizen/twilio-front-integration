                    ...
                    <div className="mx-auto w-full max-w-[740px] space-y-6">
                        ...
                        {integration && (
                            <div className="space-y-4">
                                ...
                                <div><div className="blanc-eyebrow">X-BLANC-API-KEY</div><div className="flex items-center gap-2 mt-1"><code className="flex-1 bg-[rgba(25,25,25,0.03)] px-3 py-2 rounded text-sm font-mono break-all">{integration.key_id}</code><Button variant="outline" size="sm" onClick={() => copyToClipboard(integration.key_id, 'API Key')}><Copy className="h-4 w-4" /></Button></div></div>
                                ...
                                <div><div className="blanc-eyebrow">Example Usage</div><pre className="mt-1 bg-[rgba(25,25,25,0.03)] px-3 py-2 rounded text-xs font-mono overflow-x-auto whitespace-pre">{`curl -X POST https://your-domain/api/v1/integrations/leads \\
