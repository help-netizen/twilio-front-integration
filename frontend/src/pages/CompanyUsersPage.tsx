    ...
    return (
        <div className="max-w-6xl mx-auto p-6 space-y-6">
            <div className="flex items-start justify-between gap-4">
                <div>
                    <div className="blanc-eyebrow">Team</div>
                    <h1 className="text-2xl font-semibold" style={{ fontFamily: 'var(--blanc-font-heading, Manrope), sans-serif', color: 'var(--blanc-ink-1, #202734)' }}>Company users</h1>
                    <p className="text-sm text-muted-foreground mt-1">Manage who can sign in, their role, and what they can do.</p>
                </div>
