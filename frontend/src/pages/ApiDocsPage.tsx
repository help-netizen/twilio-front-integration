    ...
    return (
        <div style={{ display: 'flex', height: '100vh', background: 'var(--blanc-panel-surface)' }}>
            <aside style={{ width: '260px', minWidth: '260px', borderRight: '1px solid var(--blanc-line)', background: 'rgba(25, 25, 25, 0.03)', overflowY: 'auto', padding: '24px 0' }}>
                <div style={{ padding: '0 20px', marginBottom: '24px' }}><h2 style={{ fontSize: '16px', fontWeight: 700, color: 'var(--blanc-ink-1)', margin: 0 }}>BLANC API</h2><p style={{ fontSize: '12px', color: 'var(--blanc-ink-3)', margin: '4px 0 0' }}>Developer Reference</p></div>
            ...
            <main id="docs-content" style={{ flex: 1, overflowY: 'auto', padding: '32px 48px 80px' }}>
                <div style={{ maxWidth: '900px' }}>
                    <h1 style={{ fontSize: '28px', fontWeight: 700, color: 'var(--blanc-ink-1)', margin: '0 0 8px' }}>BLANC API Reference</h1>
                    ...
                    <section ref={el => { sectionRefs.current['authentication'] = el; }} id="authentication" style={{ marginBottom: '48px', scrollMarginTop: '24px' }}>
                        ...
                        <p style={{ fontSize: '14px', color: 'var(--blanc-ink-2)', lineHeight: '1.7', margin: '0 0 16px' }}>All external API requests are authenticated using an <strong>API Key</strong> and <strong>API Secret</strong> sent as HTTP headers. Credentials are generated in <a href="/settings/integrations" style={{ color: 'var(--blanc-accent)', textDecoration: 'underline' }}>Settings → Integrations</a>.</p>
