...
export default function AdminCompanyDetailPage() {
    ...
    // Значение не читается: хедер-скелетон снесён вместе с аквариумом (шелл показывает
    ...
    return (
        ...
        >
            {/* Users-зона: eyebrow на канвасе + фильтры + таблица + пагинация — ритм от родителя. */}
