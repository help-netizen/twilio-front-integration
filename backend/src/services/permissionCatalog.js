...
const PERMISSION_CATALOG = [
    ...
    },
    {
        ...
        items: [
            ...
            { key: 'jobs.close', label: 'Close jobs', description: 'Move a job to Job is Done — the final, approved close. Also required to cancel a job.' },
            { key: 'jobs.done_pending_approval', label: 'Mark Visit completed', description: 'Move a job to Visit completed — the visit is finished, but the job stays open until someone with Close jobs approves it.' },
